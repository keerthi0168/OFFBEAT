...
const Footer = () => {
  return (
    <div className="flex w-full justify-center bg-[#0B1220] border-t border-white/10 py-12">
      <div className="flex w-full max-w-7xl flex-col items-start px-6 space-y-8">
        {/* grid for links */}
        <div className="grid w-full grid-cols-1 gap-12 md:grid-cols-3">
          ...
          <div className="flex flex-col gap-3">
            <strong className="font-semibold text-white">Hosting</strong>
            <p>
              <span className="cursor-pointer font-light text-[#E5E7EB]/70 decoration-1 underline-offset-1 hover:text-[#C9A96E] hover:underline transition-colors duration-300">
                Host your home
              </span>
        ...
        <div className="flex w-full flex-col items-center justify-between gap-4 md:gap-0 lg:flex-row">
          <div className="mt-2 flex w-full justify-between gap-10 md:order-last md:w-auto">
            <div className="flex text-sm font-semibold text-[#E5E7EB]">
              <svg
              ...
              English(IN) <span className="mx-4 text-[#C9A96E]">₹ INR</span>
            </div>
            <div className="flex gap-3">
              {/* facebook icon */}
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-6 w-6 cursor-pointer text-[#E5E7EB] hover:text-[#C9A96E] transition-colors duration-300"
                viewBox="0 0 50 50"
                fill="currentColor"
              >
          ...
          <div className="flex w-full flex-col gap-2 px-1 font-light text-[#E5E7EB]/70 md:w-auto md:flex-row md:items-center md:gap-8">
            ...
            <div>
              <ul className=" flex gap-6 text-sm text-[#E5E7EB]/70">
                ...
                <li className="cursor-pointer list-disc text-[#E5E7EB]/70 decoration-1 underline-offset-1 hover:text-[#C9A96E] hover:underline transition-colors duration-300">
                  Terms
                </li>
                <li className="cursor-pointer list-disc text-[#E5E7EB]/70 decoration-1 underline-offset-1 hover:text-[#C9A96E] hover:underline transition-colors duration-300">
                  Sitemap
