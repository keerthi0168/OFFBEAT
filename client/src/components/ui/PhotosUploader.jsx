  ...
  return (
    <>
      <div className="flex gap-2">
        ...
        />
        <button
          className="rounded-2xl bg-gradient-to-r from-[#C9A96E] to-[#D4B896] px-4 text-[#0B1220] font-semibold hover:from-[#D4B896] hover:to-[#E0C5A0] transition-all duration-300"
