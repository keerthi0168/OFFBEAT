...
const PlaceGallery = ({ place }) => {
  ...
  if (showAllPhotos) {
    return (
      <div className="fixed inset-0 z-20 overflow-auto bg-[#0B1220] text-white">
        <div className="grid gap-4 bg-[#0B1220] px-2 py-20 md:p-8">
          <div>
            <button
              className="fixed right-2 top-8 flex gap-1 rounded-2xl bg-white/5 border border-white/10 py-2 px-4 text-[#E5E7EB] shadow-lg backdrop-blur-md md:right-12"
  ...
  return (
    <div className="relative">
      ...
      <button
        className="absolute bottom-2 right-2 flex gap-1 rounded-xl bg-white/5 border border-white/10 py-2 px-4 shadow-md text-[#E5E7EB] backdrop-blur-md"
        onClick={() => setShowAllPhotos(true)}
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
