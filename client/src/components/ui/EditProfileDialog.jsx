  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <Button className="bg-gradient-to-r from-[#C9A96E] to-[#D4B896] text-[#0B1220] hover:from-[#D4B896] hover:to-[#E0C5A0]">
      ...
      <DialogContent className="sm:max-w-[500px]">
        <div className="flex justify-center">
          <div className="relative h-40 w-40 cursor-pointer overflow-hidden rounded-full bg-white/5 border border-white/10">
            <div
              className="absolute flex h-full w-full items-center justify-center bg-white/5 hover:z-10"
            ...
            >
              ...
              />
              <Upload height={50} width={50} color="#C9A96E" />
            </div>
