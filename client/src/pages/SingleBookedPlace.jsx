...
const SingleBookedPlace = () => {
  ...
  const getBookings = async () => {
    try {
      setLoading(true);
      const { data } = await axiosInstance.get('/get-bookings');
    ...
    <div>
      ...
      {booking?.place ? (
        <div className="p-4">
          ...
          />
          <div className="my-6 flex flex-col items-center justify-between rounded-2xl bg-white/5 backdrop-blur-md border border-white/10 p-6 sm:flex-row">
            <div className=" ">
