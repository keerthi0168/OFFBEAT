...
const PlacePage = () => {
  ...
  return (
    <div className="mt-4 overflow-x-hidden px-8 pt-20 ">
      ...
      <div className="-mx-8 border-t border-white/10 bg-white/5 backdrop-blur-md px-8 py-8">
        <div>
          <h2 className="mt-4 text-2xl font-light text-white">Extra Info</h2>
        </div>
        <div className="mb-4 mt-2 text-sm leading-5 text-[#E5E7EB]/80">
          {place.extraInfo}
        </div>
      </div>
    </div>
