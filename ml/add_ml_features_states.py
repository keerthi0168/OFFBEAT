...
for place in data:
    ...
    place['has_google_url'] = bool(place.get('google_url'))
...
# Save back
with open('dataset/hidden_places_states.json', 'w', encoding='utf-8') as f:
    json.dump(data, f, ensure_ascii=False, indent=2)

print('ML features added to hidden_places_states.json')
